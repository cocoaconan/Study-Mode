...
function hex(e){
	for(var t=[],n=new DataView(e),r=0;r<n.byteLength;r+=4){
		var o=n.getUint32(r),i=o.toString(16),a="00000000",u=(a+i).slice(-a.length);
		t.push(u)
	}
	return t.join("")
}
var dclCounter=0,dcl=function(e){
	return dclCounter++,DEVELOPMENT_MODE&&console.log(e),!0},
	parseDomainFromUrl=function(e){
		var t,n;return n=document.createElement("a"),n.href=e,t=n.hostname
	},
	parseProtocolFromUrl=function(e){
		...
		return{seconds:0}},getTimeObj=function(){
			return{
				day:{tens:0,units:0,implicitlyActive:!1,unit:TIME_UNIT_DAY
		},
		hour:{
			tens:0,units:0,implicitlyActive:!1,unit:TIME_UNIT_HOUR
		},
		minute:{
			tens:0,units:0,implicitlyActive:!1,unit:TIME_UNIT_MINUTE
		},
		second:{
			tens:0,units:0,implicitlyActive:!1,unit:TIME_UNIT_SECOND
		}
	}
},
getDateString=function(e){
	var t,n,r,o,i;
	return n=e?new Date(e):new Date,
	r=n.getFullYear(),
	o=n.getMonth()+1,
	o=10>o?"0"+o:o,
	i=n.getDate(),
...
addDelegateEventListener=function(e,t,n){
	...
	return document.addEventListener(t,function(t){
		t.stopPropagation(),r=getClosestMatchingAncestor(t.target,e),r&&n(t,r)}),!0
},
...
addMultiEventListener=function(e,t,n,r){
	var o,i=t.split(",");
	for(o=0;o<i.length;o++)e.addEventListener(i[o],function(e){n(e,this)},r)
},
getHSL=function(e,t){
	var n,r,o,i;
...
getTotalSecondsForDate=function(e,t){
	var n=0;for(var r in e)e.hasOwnProperty(r)&&e[r].days[t]&&(n+=e[r].days[t].seconds);
	return n
},
getPercentageString=function(e,t){
	var n=parseInt(100*e).toString(),
	r=n.substr(0,n.length-2)||0,o=n.substr(-2);
...
convertArrayToCsv=function(e,t,n){
	...
	for(r=getDateDiffDays(t,n),s=getDatesSparse(t,r),o=Object.keys(e).sort(),d="Domain,"+s.join(",")+"\n",i=0;i<o.length;i++){
		for(d+=o[i],a=0;a<s.length;a++)u=e[o[i]].days[s[a]],d+=","+(u?u.seconds:0);d+="\n"
	}return d
},
initiateDownload=function(e,t,n){
	var r=new Blob(e,{type:t}),o=window.URL.createObjectURL(r),i=document.createElement("a");
...
getAvailableElementWidth=function(e){
	var t=0;
	return t+=parseInt(window.getComputedStyle(e).getPropertyValue("width")),
